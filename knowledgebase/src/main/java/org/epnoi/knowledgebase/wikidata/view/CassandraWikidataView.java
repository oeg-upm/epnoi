...
public class CassandraWikidataView {
	...
	private static final Logger LOG = LoggerFactory.getLogger(CassandraWikidataView.class);
	...
	public CassandraWikidataView(String URI) {
		this.URI = URI;
	...
	public Set<String> getRelated(String sourceLabel, String type) {
		...
		LOG.info("Inital sourceIRIs obtained from the label" +sourceIRIs);
		if (sourceIRIs != null) {

			for (String sourceIRI : sourceIRIs) {
				LOG.info("sourceIRI " + sourceIRI);
				Set<String> targetIRIs = this.getIRIRelatedIRIs(type, sourceIRI);
				 LOG.info(" ("+sourceIRI+") targetIRIs " + targetIRIs);
				if (targetIRIs != null) {
					for (String targetIRI : targetIRIs) {
						 LOG.info(" trying > "+ targetIRI);
	...
	public static void main(String[] args) {
		...
		LOG.info("It took " + (System.currentTimeMillis() - currentTime) + " to retrieve the wikidata view");

		currentTime = System.currentTimeMillis();
		wikidataView.count();
		LOG.info("It took " + (System.currentTimeMillis() - currentTime) + " to clean the wikidata view");
