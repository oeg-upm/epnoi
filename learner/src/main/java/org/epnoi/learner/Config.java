...
public class Config {
    ...
    public RelationalPatternsModelCreator lexicalPatternsModelCreator() {
        ...
        try {
            relationalPatternsModelCreator.init(helper, lexicalPatternsModelCreationParameters);
    ...
    public RelationalPatternsModelCreator syntacticPatternsModelCreator() {
        ...
        try {
            relationalPatternsModelCreator.init(helper, syntacticPatternsModelCreationParameters);
        } catch (EpnoiInitializationException e) {
            e.printStackTrace();
        }
