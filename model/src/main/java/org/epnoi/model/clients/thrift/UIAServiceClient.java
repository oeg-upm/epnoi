...
public class UIAServiceClient extends ThriftClient {
    ...
    public org.epnoi.model.domain.resources.Resource getResource(String uri, String type) {
        try {
            ...
            return ((org.epnoi.model.domain.resources.Resource) SerializationUtils.deserialize(content.getResource()));
        } catch (TException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static void main(String[] args) {
        ...
        org.epnoi.model.domain.resources.Resource resource = null;
        try {
